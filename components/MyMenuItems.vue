<template>
  ...
  <div class="w-full border-neutral-900 border-b-[1px] flex justify-start">
    <div
      class="flex items-center gap-2 border-b-[2px] border-transparent p-2 px-5 cursor-pointer"
    ...
    >
      ...
      <div class="w-full px-3 flex flex-col justify-between">
        ...
        <div class="flex justify-between items-center font-bold">
          <UButton
            v-if="!menuItem.added"
            @click="addToSuggestions(menuItem)"
